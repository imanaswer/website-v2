...
const TONES = {
  ...
  outline: { background: "transparent", color: "var(--text-brand)", border: "1px solid var(--border-strong)" },
};
  ...
  return (
    <span
      style={{
        ...
        letterSpacing: "0.02em", padding: "0.3rem 0.65rem",
        borderRadius: "var(--radius-pill)", lineHeight: 1.1, whiteSpace: "nowrap",
        ...t, ...style,
      }}
      {...rest}
    >
