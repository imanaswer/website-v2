  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem", ...containerStyle }}>
      {label && (
        ...
        }}>{label}{required && <span style={{ color: "var(--red-600)" }}> *</span>}</label>
      )}
      <div style={{
        ...
        <select
          ...
          style={{
            ...
            background: "transparent", fontFamily: "var(--font-sans)", fontSize: "0.9375rem",
            color: "var(--text-primary)", padding: "0.8rem 2.4rem 0.8rem 0.9rem",
