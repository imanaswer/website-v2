...
export function Accordion({ items = [], defaultOpen = 0, allowMultiple = false, style, ...rest }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem", ...style }} {...rest}>
      {items.map((it, i) => {
          ...
          <div key={i} style={{
            ...
            <button
              ...
              style={{
                ...
                gap: "1rem", padding: "1.1rem 1.25rem", background: "transparent", border: "none",
            ...
            <div style={{
              ...
              <div style={{ overflow: "hidden" }}>
                <div style={{
                  padding: "0 1.25rem 1.25rem", fontFamily: "var(--font-sans)",
                  fontSize: "0.9375rem", lineHeight: 1.65, color: "var(--text-secondary)",
                }}>{it.a || it.content}</div>
              </div>
            </div>
          </div>
