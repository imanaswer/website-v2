...
(function () {
  ...
  const { Button, Badge, Avatar } = window.SriGujaratiVidyalayaDesignSystem_89aa2a;
      ...
      <section className="section">
        <div className="container container--wide">
          <Reveal style={{ textAlign: "center", marginBottom: "var(--space-12)" }}>
            <Kicker><span style={{ display: "inline-flex", margin: "0 auto" }}>Since 1869</span></Kicker>
    ...
    return (
      <section className="section">
        <div className="container container--narrow" style={{ textAlign: "center" }}>
          <Reveal>
            <Kicker><span style={{ display: "inline-flex", margin: "0 auto" }}>In their words</span></Kicker>
  ...
  function AdmissionsCTA({ onNavigate }) {
    return (
      <section style={{ padding: "var(--section-y) 0" }}>
        <div className="container container--wide">
          <Reveal>
            <div className="cta-band" style={{ position: "relative", overflow: "hidden", borderRadius: "var(--radius-2xl)", background: "linear-gradient(120deg, var(--maroon-800), var(--maroon-950))", padding: "clamp(2.5rem, 5vw, 4.5rem)", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "var(--space-12)", flexWrap: "wrap" }}>
              ...
              <div style={{ position: "relative", maxWidth: "32ch" }}>
                <Badge tone="gold" dot style={{ background: "rgba(248,240,220,0.16)", color: "var(--gold-300)", marginBottom: "1.2rem" }}>Admissions Open 2026-27</Badge>
  ...
  window.HomeParts2 = { Timeline, Principal, Testimonials, News, AdmissionsCTA };
})();
